                ...
                <div className="block h-full p-6 overflow-hidden bg-white rounded shadow">
                      ...
                      <div>
                        <div className="flex mb-2">
                          ...
                          <h3 className="font-medium" data-config-id="name1">
                            Apakah anda setuju dengan adanya UU Cipta Kerja?
                          </h3>
                        </div>
                        <p
                  ...
                  <div className="mb-7">
                    <p className="text-sm" data-config-id="desc1">
                      Ini adalah polling tentang apakah Anda setuju atau tidak
                      dengan adanya UU Cipta Kerja di Indonesia. Kami ingin tahu
                      pandangan Anda dan hasilnya dapat membantu dalam memahami
                      opini masyarakat terkait isu ini. Mohon berikan ...
                    </p>
                  </div>
                  <div>
